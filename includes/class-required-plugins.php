<?php
add_action( 'tgmpa_register', 'umedical_register_required_plugins' );
 ...
 */
function umedical_register_required_plugins() {
    /*
     ...
     */
    $config = array(
        'id'           => 'umedical_tgmpa',                 // Unique ID for hashing notices for multiple instances of TGMPA.
