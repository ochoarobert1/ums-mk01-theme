...
add_action( 'after_setup_theme', 'umedical_woocommerce_support' );
function umedical_woocommerce_support() {
...
add_action('woocommerce_before_main_content', 'umedical_woocommerce_custom_wrapper_start', 10);
add_action('woocommerce_after_main_content', 'umedical_woocommerce_custom_wrapper_end', 10);

function umedical_woocommerce_custom_wrapper_start() {
...
function umedical_woocommerce_custom_wrapper_end() {
