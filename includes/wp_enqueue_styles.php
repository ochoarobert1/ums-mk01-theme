...
function umedical_load_css() {
    ...
    if (!is_admin()){
        ...
        /*- MAIN STYLE -*/
        wp_register_style('main-style', get_template_directory_uri() . '/css/umedical-style.css', false, $version_remove, 'all');
        wp_enqueue_style('main-style');

        /*- WOOCOMMERCE OVERRIDES -*/
        if ( class_exists( 'WooCommerce' ) ) {
            wp_register_style('main-woocommerce-style', get_template_directory_uri() . '/css/umedical-woocommerce.css', false, $version_remove, 'all');
            wp_enqueue_style('main-woocommerce-style');
        }

        /*- MAIN MEDIAQUERIES -*/
        wp_register_style('main-mediaqueries', get_template_directory_uri() . '/css/umedical-mediaqueries.css', array('main-style'), $version_remove, 'all');
...
add_action('wp_enqueue_scripts', 'umedical_load_css');
