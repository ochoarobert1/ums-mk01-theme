            ...
            <div class="container p-0">
                <div class="row">
                    <div class="title-container col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        ...
                        <h1><?php _e('Archivo de', 'umedical'); ?> <?php echo get_the_author(); ?></h1>
                        <?php if ( get_the_author_meta('description')) : ?>
                        <?php echo get_avatar(get_the_author_meta('user_email')); ?>
                        <h2><?php _e('Acerca de', 'umedical'); ?> <?php echo get_the_author() ; ?></h2>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-7 col-lg-7 col-md-7 col-sm-7 col-12">
                                        <header>
                                            ...
                                            <span class="author" itemprop="author" itemscope itemptype="http://schema.org/Person"><?php _e('Publicado por:', 'umedical'); ?> <?php the_author_posts_link(); ?></span>
                                        </header>
                                        <p><?php the_excerpt(); ?></p>
                                        <a href="<?php the_permalink(); ?>" title="<?php _e('Leer Más', 'umedical'); ?>" class="btn btn-md btn-dark"><?php _e('Leer Más', 'umedical'); ?></a>
                                    </div>
                                </div>
                            </div>
                        </article>
                    ...
                    <section class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <h2><?php _e('Disculpe, su busqueda no arrojo ningun resultado', 'umedical'); ?></h2>
                        <h3><?php _e('Dirígete nuevamente al', 'umedical'); ?> <a href="<?php echo home_url('/'); ?>" title="<?php _e('Volver al Inicio', 'umedical'); ?>"><?php _e('inicio', 'umedical'); ?></a>.</h3>
                    </section>
                    <?php endif; ?>
                </div>
            </div>
