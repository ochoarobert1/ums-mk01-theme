...
if (!is_admin()) add_action('wp_enqueue_scripts', 'umedical_jquery_enqueue');
function umedical_jquery_enqueue()
{
...
add_action('after_setup_theme', 'umedical_register_navwalker');
function umedical_register_navwalker()
{
...
register_nav_menus(array(
    'header_menu' => __('Menu Header - Principal', 'umedical')
));
...
add_action('widgets_init', 'umedical_widgets_init');

function umedical_widgets_init()
{
    register_sidebar(array(
        'name' => __('Sidebar Principal', 'umedical'),
        'id' => 'main_sidebar',
        'description' => __('Estos widgets seran vistos en las entradas y páginas del sitio', 'umedical'),
    ...
    register_sidebars(4, array(
        'name'          => __('Pie de Página %d', 'umedical'),
        'id'            => 'sidebar_footer',
        'description'   => __('Estos widgets seran vistos en el pie de página del sitio', 'umedical'),
        'before_widget' => '<li id="%1$s" class="widget %2$s">',
        'after_widget'  => '</li>',
        'before_title'  => '<h2 class="widgettitle">',
        'after_title'   => '</h2>'
    ...
    //    register_sidebar( array(
    //        'name' => __( 'Sidebar de la Tienda', 'umedical' ),
    //        'id' => 'shop_sidebar',
    //        'description' => __( 'Estos widgets seran vistos en Tienda y Categorias de Producto', 'umedical' ),
    //        'before_widget' => '<li id='%1$s' class='widget %2$s'>',
    //        'after_widget'  => '</li>',
    //        'before_title'  => '<h2 class='widgettitle'>',
    //        'after_title'   => '</h2>',
...
-------------------------------------------------------------- */
add_filter('upload_mimes', 'ums_custom_mime_types');

function ums_custom_mime_types($mimes)
{
